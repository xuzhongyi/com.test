 ...
 * Function: redis常用操作封装. <br/>
 * date: 2016年3月28日 下午3:24:41 <br/>
 *
 * @author alex shan
 * @version
 */
public interface RedisService {
    ...
    /**
     * 
     * get:(用于获取指定 key的值,相当于Redis Get 命令). <br/>
     *
     * @author alex shan
     * @param key
     * @return
	...
	/**
	 * 
	 * setKeyExpire:(为指定的 key设置值及其过期时间,如果 key已经存在,将会替换旧的值,自定义设置单位时间). <br/>
	 *
	 * @author alex shan
	 * @param key
	 * @param value
